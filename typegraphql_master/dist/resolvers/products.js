...
let ProductResolver = class ProductResolver {
    ...
    ;
    createProduct({ name, description, color, stock, price, category_id, _doc }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    category(product) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield Category_1.CategoriesModel.findById(product._doc.category_id));
        });
    }
};
__decorate([
...
__decorate([
    type_graphql_1.FieldResolver(_type => (Category_1.Categories)),
