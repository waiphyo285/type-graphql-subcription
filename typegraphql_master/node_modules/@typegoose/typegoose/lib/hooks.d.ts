...
export declare const pre: {
    <T>(method: RegExp | "remove" | "save" | "init" | "validate" | DR[], fn: PreFnWithDocumentType<T>): ClassDecorator;
    <T_1>(method: RegExp | "update" | "updateOne" | "insertMany" | "count" | "find" | "findOne" | "findOneAndRemove" | "findOneAndUpdate" | "updateMany" | QMR[], fn: PreFnWithQuery<T_1>): ClassDecorator;
};
